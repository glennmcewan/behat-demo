...
class Calculator
{
     ...
     * @param int $int The number to add to the total.
     */
    ...
    /**
     * Magic __toString method, called when the Calculator object is cast to a string.
     *
     * @return string Calulator total as a string
     */
